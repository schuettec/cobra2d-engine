...
public class TargetStepAnimationController extends WalkAnimationController {

	private Point targetPoint;
	private Point sourcePoint;

	public TargetStepAnimationController(double maxStep, double legLength, double stepSize, double stepHeight,
