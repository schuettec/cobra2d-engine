...
public class WalkingEntityDemo {
	...
	public static void main(String[] args) throws Exception {
		...
		WalkingEntity e = new WalkingEntity(new Point(300, 300), 100, true);

		BasicRectangleMapCamera camera = new BasicRectangleMapCamera(new Point(100, 100), new Dimension(800, 800),
				true);
