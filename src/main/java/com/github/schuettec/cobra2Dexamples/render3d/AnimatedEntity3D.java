...
public class AnimatedEntity3D extends BasicCircleEntity implements CircleRenderable, Updatable, Obstacle, Renderable3D {
  ...
  public AnimatedEntity3D(String modelAdress, Point worldCoordinates, double radius) {
  ...
  public void update(WorldAccess worldAccess, float deltaTime) {
    ...
    if (nonNull(animationController)) {
  ...
  public void render3D(ModelAccess modelAccess, Environment environment, ModelBatch modelBatch,
    ...
    if (isNull(modelInstance)) {
      ...
      this.animationController.setAnimation("Cube|CubeAction.001", -1);
    }
