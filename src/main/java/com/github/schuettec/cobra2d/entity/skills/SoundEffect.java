...
public interface SoundEffect extends Entity {
	...
	/**
	 * @return Returns the sound range collision shape. Used by cameras to determine
	 *         the stereo panorama based on camera distance and position.
	 */
	public Circle getSoundRangeInWorldCoordinates();

	/**
	 * Updates the sound parameter relative to the specified entity. Used to apply
	 * pan and volumen and other effect based on the position of the listener.
	 *
	 * @param soundAccess
