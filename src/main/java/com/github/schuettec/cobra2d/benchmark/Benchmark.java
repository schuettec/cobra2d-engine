package com.github.schuettec.cobra2d.benchmark;
...
public class Benchmark implements Serializable {
	...
	public void stopBenchmark() {
		if (!this.benchmarkRunning) {
			throw new IllegalStateException("Benchmark not running. Start it before stopping.");
		}
	...
	public String getFormattedDifference() {
		try {
			return this.title + " was running " + TimeUnit.NANOSECONDS.toMillis(this.getNanoDifference()) + "ms.";
