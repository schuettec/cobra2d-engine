...
public class Benchmarker implements Serializable {
	...
	public Benchmark createBenchmark(final String title, final String description) {
		final Benchmark bench = new Benchmark(title, description);
		this.benchmarks.add(bench);
		return bench;
	}

	public Benchmark createBenchmarkAndStart(final String title, final String description) {
