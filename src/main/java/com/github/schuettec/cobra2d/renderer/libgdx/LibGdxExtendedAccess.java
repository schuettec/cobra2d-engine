...
public class LibGdxExtendedAccess {
	...
	public void drawLightTexture(String textureId, float alpha, float x, float y, float degrees) {
		...
		drawLightTexture(textureId, alpha, x, y, textureCenter.getRoundX(), textureCenter.getRoundY(),
	...
	public void drawLightTexture(String textureId, float alpha, float x, float y, float degrees, float scale) {
		Point textureCenter = renderer.getRendererAccess()
		    .getTextureCenter(textureId);
		Dimension textureDimension = renderer.getRendererAccess()
		    .getTextureDimension(textureId);
	...
	public void drawLightTexture(String textureId, float alpha, float x, float y, float originX, float originY,
	    float width, float height, float scaleX, float scaleY, float rotation, int srcX, int srcY, int srcWidth,
