...
public class ImageMath {
	...
	public static float spline(float x, final int numKnots, final float[] knots) {
		...
		c3 = ImageMath.m00 * k0 + ImageMath.m01 * k1 + ImageMath.m02 * k2 + ImageMath.m03 * k3;
		c2 = ImageMath.m10 * k0 + ImageMath.m11 * k1 + ImageMath.m12 * k2 + ImageMath.m13 * k3;
		c1 = ImageMath.m20 * k0 + ImageMath.m21 * k1 + ImageMath.m22 * k2 + ImageMath.m23 * k3;
		c0 = ImageMath.m30 * k0 + ImageMath.m31 * k1 + ImageMath.m32 * k2 + ImageMath.m33 * k3;
	 ...
	 */
	public static void resample(final int[] source, final int[] dest, final int length, final int offset,
	    final int stride, final float[] out) {
		int i, j;
		float sizfac;
		float inSegment;
		float outSegment;
