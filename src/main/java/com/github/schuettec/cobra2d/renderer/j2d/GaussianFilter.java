...
public class GaussianFilter extends ConvolveFilter {
	...
	public BufferedImage filter(final BufferedImage src, BufferedImage dst) {
		...
		GaussianFilter.convolveAndTranspose(this.kernel, inPixels, outPixels, width, height, this.alpha,
		    GaussianFilter.CLAMP_EDGES);
		GaussianFilter.convolveAndTranspose(this.kernel, outPixels, inPixels, height, width, this.alpha,
		    GaussianFilter.CLAMP_EDGES);
	...
	public static void convolveAndTranspose(final Kernel kernel, final int[] inPixels, final int[] outPixels,
	    final int width, final int height, final boolean alpha, final int edgeAction) {
